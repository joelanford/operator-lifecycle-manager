...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SubscriptionCompatibility) DeepCopyInto(out *SubscriptionCompatibility) {
	*out = *in
	if in.CompatiblePlatforms != nil {
		in, out := &in.CompatiblePlatforms, &out.CompatiblePlatforms
		*out = make([]PlatformVersions, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SubscriptionCompatibility.
func (in *SubscriptionCompatibility) DeepCopy() *SubscriptionCompatibility {
	if in == nil {
		return nil
	}
	out := new(SubscriptionCompatibility)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SubscriptionLifecycleStatus) DeepCopyInto(out *SubscriptionLifecycleStatus) {
	*out = *in
	if in.CurrentPhaseEndDate != nil {
		in, out := &in.CurrentPhaseEndDate, &out.CurrentPhaseEndDate
		*out = (*in).DeepCopy()
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SubscriptionLifecycleStatus.
func (in *SubscriptionLifecycleStatus) DeepCopy() *SubscriptionLifecycleStatus {
	if in == nil {
		return nil
	}
	out := new(SubscriptionLifecycleStatus)
	in.DeepCopyInto(out)
	return out
}
